...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--extra-libs='-lpthread -lm -ldhfilter -luavs3d -lavs3a' --extra-ldflags=' -L /d/avs3a/ffmpeg/lib/ --static' --enable-cross-compile --enable-gpl --enable-libarcdav3a --enable-libuavs3d --enable-static --disable-optimizations --disable-asm --disable-stripping --enable-nonfree --disable-ffplay --disable-ffprobe --disable-doc --extra-cflags=' -I /d/avs3a/ffmpeg/include/FilterEngine/  -static' --pkg-config-flags=--static --prefix=/d/avs3a/ffmpeg/bin
...
CC_IDENT=gcc 14.2.0 (Rev1, Built by MSYS2 project)
ARCH=c
INTRINSICS=none
EXTERN_PREFIX=
CC=gcc
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DWIN32_LEAN_AND_MEAN -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__printf__=__gnu_printf__ -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC -DZLIB_CONST
CFLAGS=  -I /d/avs3a/ffmpeg/include/FilterEngine/ -static -std=c11  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts  -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized -IE:/MSYS2/mingw64/include/SDL2
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -I /d/avs3a/ffmpeg/include/FilterEngine/ -static -g
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -L /d/avs3a/ffmpeg/lib/ --static  -Wl,--nxcompat,--dynamicbase -Wl,--high-entropy-va -Wl,--as-needed -Wl,--warn-common
...
CFLAGS-ffplay=-IE:/MSYS2/mingw64/include/SDL2 -Dmain=SDL_main
CFLAGS_HEADERS= -Wno-deprecated-declarations -Wno-unused-variable
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=-lpthread -lm -ldhfilter -luavs3d -lavs3a 
COMPAT_OBJS=
INSTALL=install
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lpsapi -lole32 -lstrmiids -luuid -loleaut32 -lshlwapi -lgdi32 -lm -latomic -lvfw32 -lmingw32 -lSDL2main -lSDL2 -lmingw32 -lSDL2main -lSDL2 -lm -lkernel32 -luser32 -lgdi32 -lwinmm -limm32 -lole32 -loleaut32 -lversion -luuid -ladvapi32 -lsetupapi -lshell32 -ldinput8
EXTRALIBS-avfilter=-lm -latomic
EXTRALIBS-swscale=-lm -latomic
EXTRALIBS-postproc=-lm -latomic
EXTRALIBS-avformat=-lm -latomic -lbz2 -lz -lsecur32 -lws2_32
EXTRALIBS-avcodec=-liconv -lm -latomic -llzma -lmfuuid -lole32 -lstrmiids -lole32 -luser32 -lz
EXTRALIBS-swresample=-lm -latomic
EXTRALIBS-avutil=-lm -luser32 -lbcrypt -latomic
EXTRALIBS-ffplay=-lmingw32 -lSDL2main -lSDL2 -lmingw32 -lSDL2main -lSDL2 -lm -lkernel32 -luser32 -lgdi32 -lwinmm -limm32 -lole32 -loleaut32 -lversion -luuid -ladvapi32 -lsetupapi -lshell32 -ldinput8 -lshell32
...
!CONFIG_LIBARCDAVS2=yes
!CONFIG_LIBARCDAVS3=yes
CONFIG_LIBARCDAV3A=yes
!CONFIG_LIBARCHDRCUVA=yes
!CONFIG_ALSA=yes
!CONFIG_APPKIT=yes
...
!CONFIG_LIBARCDAVS2_DECODER=yes
!CONFIG_LIBARCDAVS3_DECODER=yes
CONFIG_LIBARCDAV3A_DECODER=yes
...
!CONFIG_ARCDTRANSFER_FILTER=yes
